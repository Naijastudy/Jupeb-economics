    ...
    <div style={{ padding: "16px" }}>
      ...
      <div style={{
        ...
        <button onClick={handleNativeShare} style={{
          ...
          color: "#dcf8c6", fontSize: 13, fontWeight: "bold",
...
export default function App() {
  ...
  if (showSplash || authLoading) {
    ...
    return (
      <div style={{
        minHeight: "100vh", background: splashBg,
      ...
      <div style={wrap}>
        ...
        <div style={{ padding: "16px" }}>
          <div style={{ margin: 30, padding: "0 10px" }}>
            {[
              "© 2026 StudyNaija. All rights reserved.",
              "StudyNaija is an independent educational platform and is not affiliated with, endorsed by, or associated with JUPEB or any official examination body.",
              "All trademarks and names belong to their respective owners.",
            ].map((text, i) => (
              <p key={i} style={{
                fontSize: i === 0 ? 16 : 15,
                color: t.textSub, textAlign: "center",
                lineHeight: "1.8", marginTop: i === 0 ? 0 : 12,
              }}>
                {i === 1
                  ? <>{text.replace("JUPEB", "")}<strong>JUPEB</strong>{text.split("JUPEB")[1]}</>
                  : text}
              </p>
            ))}
          </div>
