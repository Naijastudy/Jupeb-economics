...
function ResultScreen({ qs, answers, t, onRetry, onHome, activeSubject, mode }) {
  ...
  const shareText =
    `${grade.emoji} I just scored ${pct}% (${correct}/${qs.length}) on ` +
  ...
  return (
    <div style={{ padding: "16px" }}>
      ...
      {/* Share card */}
      <div style={{
        background: "#075e54", border: "1px solid #128c7e",
        ...
        <button
          ...
          style={{
            ...
            padding: "14px 0", cursor: "pointer", marginBottom: 10,
            display: "flex", alignItems: "center",
        ...
        <div style={{
          marginTop: 14, background: "rgba(0,0,0,0.25)",
          borderRadius: 10, padding: "10px 12px",
          fontSize: 11, color: "#dcf8c6", textAlign: "left",
          lineHeight: 1.8, whiteSpace: "pre-line", opacity: 0.85,
        }}>
          {shareText}
        </div>
      </div>
      ...
      <button onClick={onHome} style={{
        ...
        color: t.textSub, fontSize: 13, padding: 12,
      ...
      {qs.map((q, i) => {
        ...
        return (
          <div key={i} style={{
            ...
            {!isSkipped && !isRight && (
              <div style={{
                fontSize: 12, background: t.wrongBg, borderRadius: 8,
                padding: "6px 12px", color: t.wrongText, marginBottom: 8,
              }}>
            ...
            {!isRight && (
              <div style={{
                fontSize: 12, color: t.expText, background: t.expBg,
      ...
      <button onClick={onHome} style={{
        width: "100%", background: "transparent",
        border: `1px solid ${t.border}`, borderRadius: 12,
        color: t.textSub, fontSize: 13, padding: 12, cursor: "pointer",
      }}>
        Back to Home
      </button>
    </div>
        ...
        {subjects.map((subject) => (
          ...
          >
            <div style={{
              ...
              background: subject.available ? subject.color : "#444",
              display: "flex", alignItems: "center",
            ...
            <div style={{ color: t.gold, fontSize: 20 }}>
              {subject.available ? "›" : "🔒"}
            </div>
          </button>
        ))}
...
function StreakBanner({ streak, t }) {
  ...
  return (
    <div style={{
      background: t.keyBg, border: `1px solid ${tier.color}66`,
...
useEffect(() => {
  ...
  const sendFeedback = async () => {
    if (!feedbackMessage.trim()) {
      setFeedbackError("Please write a message first.");
      return;
    }
...
const SPLASH_MESSAGES = [
  ...
  : SPLASH_MESSAGES.find((m) => progress < m.max)?.msg;
    ...
    return (
      <div style={{
        ...
        <div style={{
          fontSize: 14, color: isDark ? "#c8a84b" : "#1a3a5c",
          marginBottom: 6, letterSpacing: 2, textTransform: "uppercase",
        }}>
          JUPEB Exam Prep
        </div>
        ...
        <div style={{
          ...
          fontSize: 10, color: isDark ? "#444" : "#999",
  ...
  if (screen === "home") {
    ...
    return (
      ...
      <Toast toast={toast} onHide={hideToast} />
        ...
        {/* Header */}
        <div style={{
          background: t.bgHeader, borderBottom: `2px solid ${t.gold}`,
          ...
          <button onClick={() => goTo("profile")} style={{
            ...
            borderRadius: 8, color: t.gold, fontSize: 13,
            cursor: "pointer", padding: "6px 10px", marginRight: 8,
          }}>
            {user
          ...
          <button onClick={toggleTheme} style={{
            background: "none", border: `1px solid ${t.gold}44`,
            borderRadius: 8, color: t.gold, fontSize: 18,
        ...
        <div style={{ padding: "16px" }}>
          ...
          {/* Hero */}
          <div style={{
            background: t.heroBg, borderRadius: 16,
            ...
            <div style={{ fontSize: 20, fontWeight: "bold", color: "#fff", marginBottom: 6 }}>
              JUPEB Exam Prep 📚📝
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {HOME_CARDS.map((c) => (
                <button
                  key={c.id}
                  onClick={() => {
                    if (c.id === "grading" || c.id === "settings") goTo(c.id);
          ...
          <div style={{ textAlign: "center", color: t.textMuted, fontSize: 11, marginTop: 20, lineHeight: 2 }}>
            ...
            <a href="https://studynaija.vercel.app/" style={{ color: t.gold, textDecoration: "none" }}>
  ...
  if (screen === "subject_select") {
    return (
      <SubjectSelect
        t={t} onToggleTheme={toggleTheme} onBack={goBack} mode={pendingMode}
        onSelect={(subject) => {
      ...
      <div style={wrap}>
        ...
        <div style={{ padding: "16px" }}>
          <div style={{ margin: 30, padding: "0 10px" }}>
            {/* ✅ App-7: simpler, cleaner markup for the about paragraphs */}
            <p style={{ fontSize: 16, color: t.textSub, textAlign: "center", lineHeight: "1.8" }}>
              © 2026 StudyNaija. All rights reserved.
            </p>
            <p style={{ fontSize: 15, color: t.textSub, textAlign: "center", marginTop: 12, lineHeight: "1.8" }}>
          ...
          <div style={card}>
            ...
            {grading.map((g) => (
              <div key={g.grade} style={{
                ...
                <div style={{
                  fontSize: 13, fontWeight: "bold",
                  color: g.remark === "Fail" ? "#dc3545" : g.remark === "Excellent" ? "#5cb85c" : t.gold,
                }}>
                  {g.remark}
                </div>
              </div>
            ...
            <div style={{
              marginTop: 16, background: t.keyBg,
              border: `1px solid ${t.keyBorder}`, borderRadius: 10,
              padding: "14px", fontSize: 13, color: t.keyText, lineHeight: 2,
            }}>
  ...
  if (screen === "pastq_topics" && pqCourse && data) {
    return <PastQTopics t={t} data={data} pqCourse={pqCourse} firebaseQuestions={firebaseQuestions} subjectId={activeSubject?.id} onBack={goBack} 
   ...
   showToast("Failed to save score. Retrying... If it persists, go to Settings → Feedback.", "error"); }
    ...
    return (
      ...
      <Toast toast={toast} onHide={hideToast} />
        ...
        <QuitModal
          open={quitModal.open}
          onConfirm={quitModal.onConfirm}
          onCancel={() => setQuitModal({ open: false, onConfirm: null })}
          t={t}
        />
      </>
    );
